...
- (void)awakeFromNib {
    [super awakeFromNib];
    reason = @"";
    reasonlist = @[@"Bad Weather at pick up point",@"Bad Weather at destination", @"Would like a refund", @"Incorrect Passenger Details", @"Not available on this date anymore",@"Want to change all details on booking",@"Other reasons"];
