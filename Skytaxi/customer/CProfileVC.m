...
@interface CProfileVC ()<UICollectionViewDelegate, UICollectionViewDataSource, MKMapViewDelegate,CLLocationManagerDelegate>{
...
- (void)loadData{
    [SVProgressHUD show];
    [[HttpApi sharedInstance] getProfileInfo:customer.userId Type:@"1" Completed:^(NSMutableDictionary *result){
        [SVProgressHUD dismiss];
        NSNumberFormatter *f = [[NSNumberFormatter alloc] init];
        f.numberStyle = NSNumberFormatterDecimalStyle;
        NSString *tf_str = [result objectForKey:@"tf_time"];//[f numberFromString:tf_str];
        ...
        //NSNumber *count_num = [f numberFromString:count_str];
